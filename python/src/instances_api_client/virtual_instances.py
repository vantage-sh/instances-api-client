...
EC2Column = Literal[
    ...
    "costEmr",
    "generation",
    "coremarkIterationsSecond",
    "gpuArchitectures",
    "gpuCurrentTempAvgCelsius",
    "gpuPowerMaxWattsAvg",
    "ffmpegUsedCuda",
    "ffmpegSpeed",
    "ffmpegFps",
    "gpuPowerDrawWattsAvg",
    "gpuClocksGraphicsAvg",
    "gpuClocksSmAvg",
    "gpuClocksMemoryAvg",
    "gpuClocksVideoAvg",
    "memorySpeed",
    "usesNumaArchitecture",
    "numaNodeCount",
    "maxNumaDistance",
    "coreCountPerNumaNode",
    "threadCountPerNumaNode",
    "memoryPerNumaNodeMb",
    "l3PerNumaNodeMb",
    "l3Shared",
    "computeFamily",
